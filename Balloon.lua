...
balloon.process_balloon = function(message, mode)
    ...
    message = message:gsub(chat_color_codes.standard, "@93537") --color code 1 (black/reset)
    message = message:gsub(chat_color_codes.item, "@1111") --color code 2 (green/regular items)
    message = message:gsub(chat_color_codes.key_item, "@2222") --color code 3 (blue/key items)
    message = message:gsub(chat_color_codes.blue, "@3333") --color code 4 (blue/???)
    message = message:gsub(chat_color_codes.magenta, "@4444") --color code 5 (magenta/equipment?)
    message = message:gsub(chat_color_codes.cyan, "@5555") --color code 6 (cyan/???)
    message = message:gsub(chat_color_codes.yellow, "@6666") --color code 7 (yellow/???)
    message = message:gsub(chat_color_codes.orange, "@7777") --color code 8 (orange/RoE objectives?)
    ...
    message = message:gsub("@1111", '\\cs('..ui._type.items..')')
    message = message:gsub("@2222", '\\cs('..ui._type.keyitems..')')
    message = message:gsub("@3333", '\\cs('..ui._type.keyitems..')')
    message = message:gsub("@4444", '\\cs('..ui._type.gear..')')
    message = message:gsub("@5555", '\\cs(0,159,173)')
    message = message:gsub("@6666", '\\cs(156,149,19)')
    message = message:gsub("@7777", '\\cs('..ui._type.roe..')')
